Похоже, у вас есть несколько файлов в проекте. На основе структуры файлов я обновлю README для вашего проекта с учетом текущих файлов. Вот как может выглядеть ваш файл `README.md`:
